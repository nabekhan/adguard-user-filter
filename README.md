...
| Platform | Subscription path             |
| -------- | ----------------------------- |
| iOS      | `dist/dnsfilters/ios.txt`     |
| Android  | `dist/dnsfilters/android.txt` |
| Mac      | `dist/dnsfilters/mac.txt`     |
| Windows  | `dist/dnsfilters/windows.txt` |
| Linux    | `dist/dnsfilters/linux.txt`   |
